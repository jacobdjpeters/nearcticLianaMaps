...
This map is a combination of species distribution models for the eight taxa for which we predicted the current distribution. 

In essence, we simply added each raster output together, so the "redder" pixels in the below image correspond to higher likelihood of more liana taxa being present. 
